...
def build_model(params, dico):
    ...
    if params.encoder_only:
        ...
        # build
        encoder = TransformerModel(params, dico, is_encoder=True, with_output=False,with_embeddings=False)  # TODO: only output when necessary - len(params.clm_steps + params.mlm_steps) > 0
